...
function LightSensePage() {
  ...
  const labelStyle: React.CSSProperties = {
    color: P.primary, fontSize: 11, letterSpacing: "0.08em", fontWeight: 700, marginBottom: 14,
        ...
        <div style={{ padding: "0 16px", marginTop: -36, position: "relative", zIndex: 2 }}>
          <div style={{
            ...
            <StatCol label={t("明るさ", "BRIGHTNESS")} divider>
              <div style={{ fontSize: 20, fontWeight: 700, color: P.primary, fontVariantNumeric: "tabular-nums" }}>{brightness}%</div>
            </StatCol>
...
function StatCol({ label, children, divider }: { label: string; children: React.ReactNode; divider?: boolean }) {
  return (
    <div style={{
      ...
      <div style={{ fontSize: 9, letterSpacing: "0.12em", color: P.text3, fontWeight: 700, marginBottom: 8 }}>{label}</div>
