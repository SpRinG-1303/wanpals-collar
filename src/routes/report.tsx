      ...
      <div style={{
        ...
        <div>
          ...
          <div style={{
            ...
            {t("'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            remove all the content related to japan and japenese from this app", "'''Do not make any visual modifications. The phrases I write are commands to understand what I want, not to be written down. Understand their content well, then execute what is required.'''\n                                        \n                                            \n                                            remove all the content related to japan and japenese from this app")}
          </div>
          <div style={{
