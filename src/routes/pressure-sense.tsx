...
function StatCol({ label, value, unit, valueColor = G.text, divider, small }: {
  ...
  return (
    <div style={{
      ...
      <div style={{
        fontSize: small ? 13 : 18, fontWeight: 700, color: valueColor,
    ...
    <CardG borderColor={G.primary} shadow="0 4px 24px rgba(212,168,67,0.12)">
      ...
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 12, alignItems: "center" }}>
        ...
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ marginTop: -16, fontWeight: 800, fontSize: 42, color: G.text, lineHeight: 1 }}>
  ...
  return (
    <CardG borderColor={G.accent}>
      ...
      <div style={{ marginTop: 4 }}>
        <div style={{ fontSize: 48, fontWeight: 800, color: G.primary, lineHeight: 1 }}>
      ...
      <div style={{ display: "flex", alignItems: "center", gap: 8, marginTop: 12, flexWrap: "wrap" }}>
        ...
        <span style={{
          background: G.light, color: G.medium, fontSize: 11, fontWeight: 700,
          padding: "5px 10px", borderRadius: 50,
        }}>{t("本日 142回", "Today 142")}</span>
        <span style={{ color: G.ok, fontSize: 13, fontWeight: 700 }}>+12 ▲</span>
      </div>
    ...
    <CardG borderColor={G.accent}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "120px 1fr", gap: 16, alignItems: "center" }}>
        ...
        <div style={{ textAlign: "center" }}>
          ...
          <div style={{ fontSize: 20, fontWeight: 700, color: G.primary, lineHeight: 1.2 }}>{fill}%</div>
        </div>
        {/* Stats */}
...
function HydroRow({ jp, en, value, valueColor }: { jp: string; en: string; value: string; valueColor?: string }) {
  ...
  return (
    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
      ...
      <span style={{ fontSize: 13, fontWeight: 700, color: valueColor ?? G.text }}>
...
function SectionLabel({ jp, en, inline }: { jp: string; en: string; inline?: boolean }) {
  ...
  return (
    <div style={{
      ...
      <span style={{
        fontSize: 11, color: G.primary, fontWeight: 700,
