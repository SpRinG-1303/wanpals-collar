...
type AvatarState = {
  ...
  avatarStatus: "default" | "customised" | "ghibli_pending" | "ghibli_ready";
};
        ...
        <div key={String(screen)} style={{ animation: "fadeSlide .35s ease both" }}>
          ...
          {screen === 2 && (
            <Step2
              ...
              onBack={() => setScreen(1)}
              onNext={() => {
                update({ avatarStatus: "ghibli_ready" });
                setScreen(3);
              }}
            />
          )}
...
function Step1({
  ...
  return (
    <div style={{ paddingBottom: 120 }}>
        ...
        {BREEDS.map((b) => {
          ...
          return (
            ...
            >
              ...
              <div style={{ fontSize: 11, fontWeight: 700, marginTop: 4, color: TEXT, lineHeight: 1.2 }}>
                {b.name}
              </div>
            </button>
          );
      ...
      >
        <h3 style={{ fontSize: 16, fontWeight: 800, margin: 0 }}>Customise</h3>
  ...
  return (
    <div style={{ paddingBottom: 120 }}>
      ...
      <div style={{ margin: "20px 20px 0" }}>
        <p style={{ fontSize: 13, color: MUTED, fontWeight: 700, margin: "0 0 10px" }}>
    ...
    >
      {loading ? (
        ...
        <>
          ...
          <div style={{ fontSize: 12, color: ROSE, fontWeight: 800, marginTop: 8 }}>
            ✓ {label}
          </div>
        </>
      ) : (
        <>
          ...
          <div style={{ fontSize: 13, fontWeight: 700, color: TEXT, marginTop: 8 }}>{label}</div>
    ...
    <div style={{ paddingBottom: 120 }}>
      ...
      >
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          <div style={{ fontSize: 13, fontWeight: 800, color: TEXT }}>Set as profile picture</div>
        ...
        <button
          style={{
            ...
            fontWeight: 800, fontSize: 13, fontFamily: FONT, cursor: "pointer",
          }}
        >
          Set ✓
        </button>
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <span style={{ fontWeight: 800, fontSize: 13, color: TEXT }}>{pose.name}</span>
          <span
            style={{
...
function SectionTitle({ children }: { children: React.ReactNode }) {
  return (
    <h3 style={{ fontSize: 14, fontWeight: 800, color: TEXT, margin: "20px 20px 6px" }}>
      {children}
    </h3>
  );
}
function Label({ children }: { children: React.ReactNode }) {
  return <div style={{ fontSize: 12, fontWeight: 700, color: MUTED, marginTop: 16 }}>{children}</div>;
}
