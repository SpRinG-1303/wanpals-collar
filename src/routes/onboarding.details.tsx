      ...
      >
        <div className="px-6 pt-4">
          ...
          <div
            ...
            style={{ background: "#FFFFFF", boxShadow: "0 4px 22px rgba(0,0,0,0.06)" }}
          >
            ...
            {/* Collar */}
            <SectionLabel>{t("スマート首輪", "Smart Collar")}</SectionLabel>

            <FieldLabel optional>{t("首輪ID / デバイスID", "Collar ID / Device ID")}</FieldLabel>
            <input
              value={collarId}
            ...
            <div className="text-[11px] mt-1.5" style={{ color: "var(--text-secondary)" }}>
              {t(
                "Pawsitive Diagnostics 首輪の裏面に記載されています",
                "Find this on the back of your Pawsitive Diagnostics collar"
              )}
            </div>
            ...
            >
              ...
              <ToggleSwitch on={strayMon} onClick={() => setStrayMon((v) => !v)} />
            </div>
          </div>
        </div>
