  ...
  return (
    <div className="mt-2">
      ...
      <RoleCard
        ...
        accent="#F472B6"
        accentSoftBorder="#FCE7F3"
        iconBg="#FFF0F5"
        shadow="0 4px 16px rgba(244,114,182,0.1)"
        icon={
          <div className="relative" style={{ width: 32, height: 32 }}>
            <PawPrint size={28} style={{ color: "#F472B6", position: "absolute", top: 0, left: 2 }} strokeWidth={2} />
            <Heart size={12} fill="#F9A8D4" style={{ color: "#F9A8D4", position: "absolute", bottom: -2, right: -2 }} />
          </div>
        }
        titleJp="いぬの家族"
        titleEn="Pet Family"
