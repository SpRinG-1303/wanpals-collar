...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Pawsitive / ポジティブ — AI Smart Dog Collar" },
      ...
      { property: "og:title", content: "Pawsitive / ポジティブ — AI Smart Dog Collar" },
      ...
      { name: "twitter:title", content: "Pawsitive / ポジティブ — AI Smart Dog Collar" },
