...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Pawsitive Diagnostics: AI-powered smart animal collar app. Track health, location, and connect with vets." },
      { name: "author", content: "Pawsitive Diagnostics" },
      { property: "og:title", content: "Pawsitive Diagnostics — AI Smart Animal Collar" },
      { property: "og:description", content: "Pawsitive Diagnostics: AI-powered smart animal collar app. Track health, location, and connect with vets." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Pawsitive Diagnostics — AI Smart Animal Collar" },
      { name: "twitter:description", content: "Pawsitive Diagnostics: AI-powered smart animal collar app. Track health, location, and connect with vets." },
